...
class TripletDataloader(Dataset):
    ...
    def get_mesh(self, item):
        ...
        names = self.img_lst[item]
        names = names.split('/')
        mesh_path = self.dataset_dir+'ModelNet40_Mesh/ModelNet40_Mesh/' + names[0] + '/train/' + names[1][:-4] + '.npz'
